...
import { FileText, Download, ArrowLeft, Filter, Search } from 'lucide-react';
...
const CourseView: React.FC = () => {
  ...
  const fetchCourseDetails = async (id: string) => {
    try {
      // Assuming we have an endpoint for single course details, or we fetch from list
      // For now, let's assume we can get it from the materials response or a separate call
      // If not, we might need to update the backend to support GET /academic/courses/:id
