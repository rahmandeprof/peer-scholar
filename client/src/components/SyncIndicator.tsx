...
export function SyncIndicator() {
    ...
    useEffect(() => {
        const checkPending = async () => {
            ...
            const total = quizPending + readingPending;
    ...
    return (
        <div className={`fixed bottom-20 md:bottom-4 right-4 z-50 px-3 py-2 rounded-full flex items-center gap-2 text-xs font-medium shadow-lg ${getColorClass()}`}>
            {getIcon()}
