    ...
    <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8'>
      ...
      <div className='mb-8 flex flex-col sm:flex-row gap-4'>
        ...
        <div className='sm:w-48'>
          <select
            className='block w-full h-full pl-3 pr-10 py-2 text-sm border border-gray-300 dark:border-gray-700 focus:outline-none focus:ring-1 focus:ring-primary-500 focus:border-primary-500 rounded-xl bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 transition-colors'
            value={filterType}
