...
export function MaterialCardSkeleton() {
  return (
    <div className='bg-white/60 dark:bg-gray-800/60 backdrop-blur-xl shadow-sm rounded-2xl border border-gray-200/50 dark:border-gray-700/50 flex flex-col h-full'>
