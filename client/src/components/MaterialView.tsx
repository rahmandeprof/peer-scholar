  ...
  return (
    <ReaderSettingsProvider>
      <div className='flex flex-col h-full bg-white dark:bg-gray-900 overflow-hidden relative'>
        {/* Header */}
        <div className='absolute top-0 left-0 right-0 z-20 border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 shadow-sm'>
          {/* Row 1: Navigation + Title + Utility */}
          ...
          {/* Row 2: Feature Tabs (desktop only) */}
          <div className='hidden md:flex items-center gap-2 px-4 py-1.5 border-t border-gray-100 dark:border-gray-700/50 overflow-x-auto scrollbar-hide'>
            <button
              onClick={() => setQuizOpen(true)}
              className='flex px-3 py-1 bg-purple-100 dark:bg-purple-900/30 text-purple-600 dark:text-purple-400 rounded-full hover:bg-purple-200 dark:hover:bg-purple-900/50 transition-colors items-center font-medium text-xs whitespace-nowrap'
            >
            ...
            <button
              ...
              className='flex px-3 py-1 bg-indigo-100 dark:bg-indigo-900/30 text-indigo-600 dark:text-indigo-400 rounded-full hover:bg-indigo-200 dark:hover:bg-indigo-900/50 transition-colors items-center font-medium text-xs whitespace-nowrap'
            >
            ...
            <button
              ...
              className={`flex px-3 py-1 rounded-full transition-colors items-center font-medium text-xs whitespace-nowrap ${
                jotterOpen
            ...
            <button
              ...
              className='flex px-3 py-1 bg-teal-100 dark:bg-teal-900/30 text-teal-600 dark:text-teal-400 rounded-full hover:bg-teal-200 dark:hover:bg-teal-900/50 transition-colors items-center font-medium text-xs whitespace-nowrap'
            >
        ...
        <div className='flex-1 flex overflow-hidden relative pt-[60px] md:pt-[96px]'>
          {/* Content Viewer */}
