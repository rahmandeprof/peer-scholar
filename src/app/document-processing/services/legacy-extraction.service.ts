...
import { Material, ProcessingVersion } from '../../academic/entities/material.entity';
...
export class LegacyExtractionService {
    ...
    async getContent(materialId: string): Promise<string | null> {
        ...
        if (material.processingVersion !== ProcessingVersion.V1) {
            this.logger.debug(`Material ${materialId} is v2, use segment-based extraction instead`);
            return null;
        }
