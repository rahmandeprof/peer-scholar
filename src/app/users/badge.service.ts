...
import { UserBadge, BadgeType, BADGE_DEFINITIONS } from './entities/user-badge.entity';
...
export class BadgeService {
    ...
    async checkUploadBadges(userId: string, uploadCount: number): Promise<UserBadge[]> {
    ...
    async checkStreakBadges(userId: string, currentStreak: number): Promise<UserBadge[]> {
        const awarded: UserBadge[] = [];
