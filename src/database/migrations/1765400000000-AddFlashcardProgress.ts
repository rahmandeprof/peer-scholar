...
export class AddFlashcardProgress1765400000000 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DROP INDEX IF EXISTS "IDX_flashcard_progress_user_next_review"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "IDX_flashcard_progress_user_material"`);
