...
export class AddMultiUniversitySupport1765800000000 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE material DROP COLUMN IF EXISTS school_id`);
        await queryRunner.query(`ALTER TABLE "user" DROP COLUMN IF EXISTS school_id`);
    }
}
