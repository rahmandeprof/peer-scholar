...
export class AddHealthSciencesDepartments1765051000000 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        if (facultyResult.length === 0) {
            console.log('College of Health Sciences faculty not found, skipping department insertion');
            return;
        }
