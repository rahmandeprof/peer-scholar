...
export class ConvertStudySessionTypeToVarchar1765052000000 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        console.log('Successfully converted study_session.type from enum to varchar');
    }
